...
mappings/   Conversion table YAML (304 entries) — canonical data
...
- **Conversion table:** [`mappings/*.yaml`](mappings/) + [`mappings/SCHEMA.md`](mappings/SCHEMA.md) —
  canonical field-level mapping data (304 entries). When code and spec diverge, follow `docs/spec.md`.
