...
mappings/   Conversion table YAML (314 entries) — canonical data
...
- **Conversion table:** [`mappings/*.yaml`](mappings/) + [`mappings/SCHEMA.md`](mappings/SCHEMA.md) —
  canonical field-level mapping data (314 entries). When code and spec diverge, follow `docs/spec.md`.
